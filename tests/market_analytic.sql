...
select create_order(1,1,1::money, 500, 'bid');
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 36, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 37, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 38, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 39, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 40, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 41, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 42, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 43, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 44, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 45, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 46, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 47, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 48, 10);
select create_order(7,1,1::money,10, 'offer');
select create_trade(35, 49, 10);
