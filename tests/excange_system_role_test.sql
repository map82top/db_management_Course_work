...
\echo '==================== TEST 3 ======================'
\echo 'UPDATE INSTRUMENT TEMPLATE record with instrument code - 110000'
...
\echo '==================== TEST 4 ======================'
\echo 'DELETE INSTRUMENT TEMPLATE record with instrument code - 110000'
...
\echo 'Before'
SELECT * FROM get_order(35);

SELECT * FROM cancel_order(35);
